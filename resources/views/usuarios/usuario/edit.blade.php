	...
	{{Form::token()}}
		...
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				...
				<input type="text" name="Nombre" required value="{{$usuario->Nombre}}" class="form-control" placeholder="Nombres y apellidos...">
			</div>	
		</div>		
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
				<label for="Ciudad">Ciudad de residencia(*)</label>
				<input type="text" name="Ciudad" required value="{{$usuario->Ciudad}}" class="form-control" placeholder="Ciudad...">
			</div>	
		</div>
		<div class="col-lg-6 col-sm-6 col-md-6 col-xs-12">
			<div class="form-group">
