...
@section ('contenido')
	<div class="row">
		<div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
			<h3>Listado de servicios <a href="servicio/create"><button class="btn btn-success">Crear un nuevo servicio</button></a></h3>
			@include('inventario.servicio.search')	
		</div>
	</div>
	<div class="row">
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered table-condensed table-hover">
					...
					<tr>
						...
						<td>{{$serv->Estado}}</td>
						<td>
							<a href="{{URL::action('ServicioController@edit',$serv->idServicio)}}"><button class="btn btn-info">Editar</button></a>						
							<a href="" data-target="#modal-delete-{{$serv->idServicio}}" data-toggle="modal"><button class="btn btn-danger">Eliminar</button></a>							
						</td>
					</tr>
					@include('inventario.servicio.modal')
					@endforeach
				</table>
			</div>
			{{$servicios->render()}}
