  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-header">
                    ...
                    <p>
                      Foto prisma || Arte - Tecnología - Rapidez
                      <small></small>
                    </p>
                  </li>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="almacen/articulo"><i class="fa fa-circle-o"></i> Estudios fotografícos</a></li>
                <li><a href="almacen/categoria"><i class="fa fa-circle-o"></i> Productos</a></li>
              </ul>
            </li>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018<a href="www.incanatoit.com"> Foto prisma Ltda</a>.</strong> Todos los derechos reservados.
      </footer>
