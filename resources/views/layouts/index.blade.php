...
<head>
	...
	<link rel="stylesheet" href="{{asset('css/font-awesome.min1.css')}}">
	<link rel="stylesheet" href="{{asset('css/style1.css')}}">
	<link rel="Shortcut Icon" type="image/x-icon" href="{{asset('Imagenes/Cliente/shortcut-icon.ico')}}/>
...
<body>
    <div class="page-container">
        ...
        <div class="content-page cover-background font-content-index">
            <div class="jumbotron">
              <h1 class="tittles-pages">Bienvenido a FotoPrisma</h1>
              <p>Somos una empresa formada por un grupo de profesionales dedicada a proporcionar los servicios de fotografía y venta de productos.
                <br>Nuestro principal objetivo es plasmar a través de imágenes, las emociones del día más importante de tu vida. Conjuntamos lo más avanzado de la tecnología, con nuestra experiencia y trato personalizado, para lograr un servicio de excelente calidad. Sabemos lo importante de conservar estos invaluables momentos a través del tiempo, por lo que nos hemos especializado en crear recuerdos únicos para toda la vida.
              </p>
            </div>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 text-center">
                            <p class="tittles-pages">Fotoprisma te ofrece</p>
                            <br><br><br>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-xs-12 col-sm-4">
                            <div class="content-dest">
                                ...
                                <h3 class="text-center">Estudios fotograficos</h3>
                                <p class="text-justify">Realizamos tu estudio fotográfico lleno de arte, creatividad y totalmente personalizado para que puedas conservar bellos momentos.
                                </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <div class="content-dest">
                                ...
                                <p class="text-justify">Ofrecemos productos de alta calidad, durabilidad y que te permitirán conservar tus estudios dentro de marcos, albumes..Etc.
                                </p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-4">
                            <div class="content-dest">
                                ...
                                <p class="text-justify">Con intención de mantenernos actualizados, ofrecemos nuevos servicios cada cierto tiempo.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 text-center">
                            <div class="content-dest">
                                ...
                                <h3>Noticias</h3>
                                <p>Enterate de las ultimas noticias con respecto a la industria de la fotografía.
                                </p>
